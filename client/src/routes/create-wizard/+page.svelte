            ...
            <div class="bg-white w-full max-w-[700px] min-h-[850px] shadow-2xl p-12 lg:p-16 relative origin-top transition-transform duration-500 font-serif">
                ...
                <div class="mt-12 pt-8 border-t border-slate-200 font-sans">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="px-2 py-1 bg-slate-100 rounded text-[10px] font-bold text-slate-600">NAME: {typeof $intent.author_format === 'object' ? ($intent.author_format.et_al ? 'ET AL' : $intent.author_format.form) : ($intent.author_format || 'PENDING')}</span>
